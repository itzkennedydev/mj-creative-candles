...
async function updateEliteCrewneck() {
  try {
    ...
    const result = await productsCollection.updateOne(
      { _id: product._id },
      {
        $set: {
          ...
          description: "Show your Elite Volleyball pride with this premium crewneck! Comfortable and stylish, perfect for games, practices, and daily wear."
        }
      }
    );
    ...
    if (result.modifiedCount > 0) {
      ...
      console.log('   - Changed name to "Elite Volleyball Crewneck"');
