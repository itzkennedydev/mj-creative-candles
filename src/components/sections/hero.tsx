    ...
    <span className="block mt-2">
      ...
      <span className="relative inline-block ml-4">
        ...
        <span className="absolute inset-0 -left-2 -right-2 bg-[#74CADC]/40 z-0"></span>
            ...
            {/* Description */}
            <p className="text-base sm:text-lg text-[#1d1d1f]/70 max-w-lg">
            ...
            <div className="pt-8 sm:pt-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-4 md:gap-8 justify-center lg:justify-start">
                <div className="flex items-center justify-center lg:justify-start">
                  ...
                  <span className="ml-1 sm:ml-2 text-sm sm:text-base text-[#1d1d1f]/80 font-medium">4.9/5</span>
                </div>
                <div className="text-sm sm:text-base text-[#1d1d1f]/80 font-medium">500+ Happy Customers</div>
              </div>
            </div>
          </motion.div>
