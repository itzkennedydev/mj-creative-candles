    ...
    >
      ...
      <div className="flex flex-1 flex-col">
        ...
        <div className="flex-1">
          <Link href={`/shop/${product.id}`}>
            <h3
              className="mb-1 line-clamp-1 cursor-pointer text-base font-semibold text-gray-900 transition-colors hover:text-[#0A5565]"
              itemProp="name"
            >
              {product.name}
            </h3>
          ...
          <div className="mb-3 flex flex-wrap gap-1.5">
            {new Date() < new Date("2025-12-02T05:59:59Z") && (
              <span className="rounded-full bg-[#E6F7FA] px-2 py-1 text-xs font-medium text-[#0A5565]">
                15% OFF
              </span>
            )}
          </div>
        ...
        <div className="mt-auto border-t border-gray-100 pt-3">
          ...
          <Link href={`/shop/${product.id}`} className="block">
            <Button
              ...
              className="w-full rounded-xl bg-[#0A5565] py-3 text-sm font-medium text-white transition-colors hover:bg-[#083d4a]"
            >
