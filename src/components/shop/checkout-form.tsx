...
export function CheckoutForm({ appliedDiscount }: CheckoutFormProps = {}) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Build notes with order notes from cart items
      const itemOrderNotes: string[] = [];

      cartItems.forEach((item) => {
        // Get order notes from cart item
      ...
      const allNotes = itemOrderNotes.join("\n\n");
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center gap-2">
            <div className="flex h-8 w-8 items-center justify-center rounded-full bg-[#0A5565] font-medium text-white">
              1
            </div>
          ...
          <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
            <div>
              ...
              <input
                ...
                className={`w-full rounded-lg border px-4 py-3 transition-colors focus:border-transparent focus:outline-none focus:ring-2 focus:ring-[#0A5565] ${
        ...
        {cartItems.some((item) => item.product.requiresBabyClothes) && (
          <div className="rounded-xl border border-[#74CADC] bg-[#E6F7FA] p-4">
            ...
            <p className="text-sm text-[#0A5565]">
              ...
              {cartItems.find((item) => item.product.requiresBabyClothes)
                ?.product.babyClothesDeadlineDays || 5}{" "}
