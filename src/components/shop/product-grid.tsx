...
interface ProductGridProps {
  shopType?: "regular-shop" | "spirit-wear";
  searchQuery?: string;
...
export function ProductGrid({
  ...
  const filteredProducts = useMemo(() => {
    return products.filter((product) => {
      ...
      // Removed: size filtering is no longer needed
      ...
      const matchesPriceRange =
        ...
        (() => {
          ...
          // Add base price (sizes removed from product type)
  ...
  }, [products, shopType, searchQuery, selectedCategory, selectedPriceRanges]);
