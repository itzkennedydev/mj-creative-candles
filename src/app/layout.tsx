...
export const metadata: Metadata = generateSEOTags({
  title:
    "MJ Creative Candles | Custom Candles & Creative Gifts | Quad Cities, IL",
  description:
    "Premium handcrafted candles in Moline, IL serving the Quad Cities. Custom candles, personalized gifts, unique home decor. Local pickup available. Call (309) 373-6017",
  url: "https://mjcreativecandles.com",
  keywords: [
    "custom candles Quad Cities",
    "candles Moline IL",
    "handmade candles Davenport",
    "creative gifts Rock Island",
    "personalized candles Illinois",
    "handcrafted candles Iowa",
    "unique gifts Quad Cities",
    "home decor Bettendorf",
    "candles near me",
    "custom scents",
    "creative gifts",
    "local candles",
...
const homepageFaqs = [
  ...
  },
  {
    ...
    answer:
      "We offer handcrafted candles, custom scents, personalized gifts, and unique home decor items. We specialize in creating one-of-a-kind pieces perfect for any occasion or as thoughtful gifts.",
  },
  {
