...
export function XAxis({
  ...
  const tickValues = useMemo(() => {
    // Reduce max ticks for better spacing, especially for time-based labels
    const maxTicks = maxTicksProp ?? (width < 450 ? 3 : width < 600 ? 4 : width < 800 ? 5 : 6);
