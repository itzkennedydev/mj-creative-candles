...
export function Combobox({
  ...
  // Ensure selectedProp is an array and normalize it
  ...
  // Create a normalized selected values set for comparison
    ...
    <Popover
      ...
      content={
        <AnimatedSizeContainer
          ...
          height
          style={{ transform: "translateZ(0px)" }} // Fixes overflow on some browsers
          transition={{ ease: "easeInOut", duration: 0.1 }}
          className="pointer-events-auto overflow-hidden rounded-[inherit] bg-white"
        >
          <Command loop shouldFilter={shouldFilter} className="bg-white">
            {!hideSearch && (
              <div className="flex items-center overflow-hidden rounded-t-lg border-b border-neutral-200 bg-white">
                <Command.Input
            ...
            <ScrollContainer
              className={cn(
                "scrollbar-hide max-h-[50vh] w-screen overflow-y-scroll sm:w-auto bg-white",
                onCreate && !multiple && "max-h-[calc(50vh-3.5rem)]",
              )}
            >
              <Command.List
                className={cn("flex w-full flex-col gap-1 p-1 min-w-[180px] bg-white")}
              >
