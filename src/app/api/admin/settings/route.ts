...
export async function PUT(request: NextRequest) {
  try {
    ...
    if (typeof body.burndownUrgentThreshold !== 'number' || body.burndownUrgentThreshold < 1) {
      return NextResponse.json(
    ...
    if (typeof body.burndownCriticalThreshold !== 'number' || body.burndownCriticalThreshold < 1) {
      return NextResponse.json(
