...
export const metadata: Metadata = generateSEOTags({
  title: "Shop Handcrafted Candles & Spirit Wear | Quad Cities",
  ...
  keywords: [
    'buy handcrafted candles', 'shop spirit wear Quad Cities', 'custom beanies for sale',
    ...
    'team apparel Bettendorf', 'personalized gifts Quad Cities', 'candle shop near me'
  ],
});
