...
export default function OrderDetailPage() {
    ...
    const fetchOrder = async () => {
      try {
        ...
        const currentStatus = STATUS_OPTIONS.find(
          (opt) => opt.value === data.order.status,
        );
        setSelectedStatus(
          currentStatus
  ...
  const allProductImages = useMemo(() => {
    ...
    console.log(
      "allProductImages: productImages keys:",
    ...
    order.items.forEach((item) => {
      const productId = item.productId;
      console.log(
        "allProductImages: Processing item with productId:",
        productId,
        "productName:",
        item.productName,
      );
      ...
      if (!productImagesForItem) {
        const matchingKey = Object.keys(productImages).find(
          (key) =>
      ...
      if (productImagesForItem && productImagesForItem.length > 0) {
        console.log(
          "allProductImages: Found",
          productImagesForItem.length,
        ...
        console.log(
          "allProductImages: No images found for productId:",
          productId,
          "Available keys:",
          Object.keys(productImages),
        );
          ...
          <div className="space-y-6 pb-10">
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-[2fr_1fr]">
              ...
              <div className="space-y-6">
                {/* Order Info Card */}
                <div className="rounded-lg border border-neutral-200 bg-white p-5 sm:p-10">
              ...
              <div className="space-y-0">
                ...
                <div className="rounded-lg bg-white">
                  ...
                  {allProductImages.length > 0 ? (
                    ...
                    <div className="relative flex aspect-square w-full items-center justify-center overflow-hidden rounded-lg bg-neutral-100">
                      <p className="text-sm text-neutral-500">
                        No images available
                      </p>
                    </div>
                  ...
                  <div className="px-0 py-4">
                    ...
                    <div className="mb-6 px-0">
                      ...
                      <textarea
                        ...
                        className="min-h-[80px] w-full resize-none rounded-md border border-neutral-200 px-3 py-2 text-sm focus:border-transparent focus:outline-none focus:ring-2 focus:ring-neutral-500"
                      />
                    </div>
