              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  {primaryImage ? (
                    ...
                    <label className="group flex aspect-square w-full max-w-sm cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50 transition-all hover:border-[#74CADC] hover:bg-[#74CADC]/5">
                      {isUploading ? (
                        <>
                          <Loader2 className="mb-3 h-10 w-10 animate-spin text-[#74CADC]" />
                        ...
                        <>
                          <div className="mb-4 rounded-full bg-[#74CADC]/10 p-4 transition-colors group-hover:bg-[#74CADC]/20">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <label className="group flex aspect-square cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-neutral-300 bg-neutral-50 transition-all hover:border-[#74CADC] hover:bg-[#74CADC]/5">
                      {isUploading ? (
                        <Loader2 className="h-6 w-6 animate-spin text-[#74CADC]" />
                      ) : (
                        <>
                          <Upload className="mb-1 h-6 w-6 text-neutral-400 transition-colors group-hover:text-[#74CADC]" />
                          <span className="text-xs text-neutral-600 transition-colors group-hover:text-[#74CADC]">
                            Add Image
                          </span>
                        </>
                      )}
