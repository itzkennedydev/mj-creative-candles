          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>Order Process:</strong> All orders must be placed through our official channels. We reserve the right to refuse any order at our discretion.
                </p>
                <p>
                  <strong>Payment Terms:</strong> Payment is required before production begins unless otherwise agreed upon in writing. We accept various payment methods as specified during checkout.
                </p>
                <p>
                  <strong>Pricing:</strong> All prices are subject to change without notice. Current pricing will be confirmed at the time of order placement.
                </p>
              </div>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">4. Design and Artwork</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>Client Responsibility:</strong> Clients are responsible for providing artwork that they have the right to use. Clients must ensure they have proper authorization for any logos, designs, or artwork submitted.
                </p>
                <p>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold mb-4">5. Production and Delivery</h2>
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>Production Time:</strong> Production times vary based on order complexity and current workload. Estimated completion dates will be provided at order placement.
                </p>
                <p>
                  <strong>Quality Control:</strong> All items undergo quality control before delivery. We strive to meet the highest standards of craftsmanship.
                </p>
                <p>
                  <strong>Delivery:</strong> Items can be picked up at our location or delivered for an additional fee. Delivery times are estimates and not guaranteed.
                </p>
              </div>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="space-y-4 text-gray-700">
                <p>
                  <strong>Quality Issues:</strong> If there is a quality issue with your order, please contact us within 7 days of receipt. We will work to resolve the issue at no additional cost.
                </p>
                <p>
                  <strong>Custom Orders:</strong> Custom embroidered items cannot be returned unless there is a quality defect or error on our part.
                </p>
                <p>
                  <strong>Refund Policy:</strong> Refunds are issued at our discretion and may be subject to restocking fees for non-custom items.
                </p>
              </div>
            </section>
