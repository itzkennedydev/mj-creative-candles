...
const BUSINESS_EMAIL = "contact@mjcreativecandles.com";
...
const baseKeywords = [
  ...
  ...EXTENDED_QUAD_CITIES.map((city) => `${city} candle shop`),
  ...
  // ===========================================
  "where to get handcrafted candles",
  "best candle shop near me",
  "how much does handcrafted candles cost",
  "embroidery pricing",
  ...
  "stitchpleaseqc",
  "stitch please embroidery",
  "stitch please shop",
  "Tanika embroidery",
  "Tanika Zentic",
  "women owned embroidery",
...
export const defaultSEO: SEOProps = {
  title: `${BUSINESS_NAME} | Handcrafted Candles & Spirit Wear | ${QUAD_CITIES_AREA}`,
  description: `Premium handcrafted candles services in Moline, IL. Custom beanies, hoodies, t-shirts, and spirit wear for schools and teams. Serving the Quad Cities area including Davenport, Rock Island, and Bettendorf. Fast turnaround, local pickup available. Call ${BUSINESS_PHONE}`,
      ...
      images: [
        {
          ...
          width: 1200,
          height: 630,
          alt: `${BUSINESS_NAME} - Handcrafted Candles in the Quad Cities`,
        },
      ],
      locale: "en_US",
...
export function generateLocalBusinessSchema() {
  return {
    ...
    description:
      "Premium handcrafted candles services in the Quad Cities. Specializing in custom apparel, spirit wear, team uniforms, and personalized gifts.",
    url: BUSINESS_URL,
    ...
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      name: "Handcrafted Candles Services",
      itemListElement: [
        {
          "@type": "Offer",
          itemOffered: {
