...
interface ProductDocument {
  ...
  price?: number; // MJ Creative Candles
  regularPrice?: number; // MJ Candles
  salePrice?: number; // MJ Candles
  image?: string;
  imageId?: string;
...
const initialProducts: Omit<Product, "id">[] = [
  {
    ...
    description:
      "Show your UTHS pride with our premium spirit wear! Comfortable 50-50 cotton poly blend black t-shirt featuring custom LOS PANTHERS graphics. Perfect for games, events, and daily wear.",
    price: 22.0,
  ...
  },
  {
    ...
    description:
      "Stay warm while supporting UTHS! Our cozy 50-50 cotton poly blend black hoodie features the iconic LOS PANTHERS design. Ideal for chilly game nights and campus spirit events.",
    price: 35.0,
...
export async function seedProducts() {
  try {
    ...
    if (existingProducts === 0) {
      ...
      console.log(
        `Products collection already has ${existingProducts} documents`,
      );
      return 0;
    }
  } catch (error) {
